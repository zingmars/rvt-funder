...
// Project's runfile Configuration
        ...
        copy: {
            ...
            js: {
                files: [
                    ...
                    {cwd: 'bower_components/angular-sanitize',                           src: ['angular-sanitize*'],    dest: 'public/lib/angular-sanitize',                            expand: true},
                    ...
                    {cwd: 'bower_components/i18next',                                    src: ['*.js'],                 dest: 'public/lib/i18next',                                     expand: true},
                    {cwd: 'bower_components/ng-i18next',                                 src: ['dist/*.*'],             dest: 'public/lib/ng-i18next',                                  expand: true},                    
                    {cwd: 'bower_components/i18next-browser-languagedetector',           src: ['*.js'],                 dest: 'public/lib/i18next-browser-languagedetector',            expand: true},                    
                    {cwd: 'bower_components/i18next-localstorage-cache',                 src: ['*.js'],                 dest: 'public/lib/i18next-localstorage-cache',                  expand: true},
                    {cwd: 'bower_components/i18next-sprintf-postprocessor',              src: ['*.js'],                 dest: 'public/lib/i18next-sprintf-postprocessor',               expand: true},
                    {cwd: 'bower_components/i18next-xhr-backend',                        src: ['*.js'],                 dest: 'public/lib/i18next-xhr-backend',                         expand: true},
                    {cwd: 'bower_components/angular-notify/dist',                        src: ['*.*'],                  dest: 'public/lib/angular-notify',                              expand: true},
                    {cwd: 'bower_components/bootstrap-datetimepicker/build/js',          src: ['*.*'],                  dest: 'public/lib/bootstrap-datetimepicker',                    expand: true},
                    {cwd: 'bower_components/bootstrap-datetimepicker/build/css',         src: ['*.*'],                  dest: 'public/lib/bootstrap-datetimepicker',                    expand: true},
                    {cwd: 'bower_components/bootstrap-datetimepicker/src/js/locales',    src: ['*.*'],                  dest: 'public/lib/bootstrap-datetimepicker/locales',            expand: true},
                ]
            }
        },
        nodemon: {
